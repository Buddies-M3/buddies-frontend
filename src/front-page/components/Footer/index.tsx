    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          {/* <!-- Footer Top --> */}
          {!isShort && (<div className="py-20 lg:py-25">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                <motion.div
                  ...
                  transition={{ duration: 1, delay: 0.1 }}
                  viewport={{ once: true }}
                  className="animate_top w-full lg:w-[26%]"
                >
                  <h4 className="mb-9 text-itemtitle2 font-medium text-black dark:text-white">
                    Find Us
                  </h4>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              ...
              className="animate_top"
            >
              <ul className="flex items-center gap-8" style={{ listStyleType: 'none', paddingLeft: '0' }}>
                <li>
            ...
            {/* <motion.div
              ...
              className="animate_top"
            >
              <ul className="flex items-center gap-5" style={{ listStyleType: 'none', paddingLeft: '0' }}>
                <li>
                ...
                <li>
                  <a href="https://www.instagram.com/greenchainsnet" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                ...
                <li>
                  <a href="https://www.facebook.com/greenchainsnet" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
